...
export const exercises: Exercise[] = [
  {
    ...
    photo:
      "https://images.unsplash.com/photo-1598971639058-fab3c3109a00?w=800&h=600&fit=crop&auto=format",
    video: SAMPLE_VIDEO,
    duration: "0:48",
    instructions:
      "Start in a high plank. Without bending the elbows, protract and retract the shoulder blades, keeping the core braced throughout.",
    mistakes: ["Bending the elbows", "Sagging hips", "Shrugging the traps"],
    coachNote:
      "Move slowly — this primes scapular control for the pressing that follows.",
    coach: "Lucas Terra",
  },
  {
    name: "Pike Push-Up",
    ...
    duration: "1:02",
    instructions:
      "Hips high in an inverted V. Lower the crown of the head toward the floor, elbows tracking forward, then press back up.",
    mistakes: ["Flaring elbows wide", "Hips dropping", "Half range of motion"],
    coachNote:
      "Stack the shoulders over the hands — the more vertical, the harder.",
    coach: "Lucas Terra",
  },
  {
    ...
    duration: "0:55",
    instructions:
      "Lower under control, then drive through the floor explosively so the hands leave the ground. Land soft and reset.",
    mistakes: [
      "Losing core tension",
  ...
  },
  {
    ...
    equipment: "Bodyweight",
    photo:
      "https://images.unsplash.com/photo-1566241142559-40e1dab266c6?w=800&h=600&fit=crop&auto=format",
    video: SAMPLE_VIDEO,
    duration: "0:40",
    instructions:
      "From a plank, tap the opposite shoulder while resisting rotation of the hips. Keep them square to the floor.",
    mistakes: [
  ...
  },
  {
    ...
    duration: "0:38",
    instructions:
      "Press the lower back into the floor, lift shoulders and legs, and hold a shallow banana shape. Breathe.",
    mistakes: [
  ...
  },
  {
    ...
    duration: "0:50",
    instructions:
      "Knees hovering an inch off the floor, crawl forward moving opposite hand and foot. Keep the hips low and level.",
    mistakes: ["Hips bouncing up", "Same-side limbs moving", "Rushing"],
    coachNote:
      "Keep a book on your back — it should not fall. Slow and controlled.",
    coach: "Lucas Terra",
  },
];
...
export const coach = {
  ...
  avatar:
    "https://images.unsplash.com/photo-1567013127542-490d757e51fc?w=200&h=200&fit=crop&auto=format",
  message:
...
export const challenge90 = {
  ...
  photos: [
    {
      label: "Day 1",
      img: "https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=400&h=560&fit=crop&auto=format&sat=-100",
    },
    {
      label: "Day 30",
      img: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&h=560&fit=crop&auto=format&sat=-100",
    },
  ],
};
...
export const rewards = [
  {
    ...
    desc: "Unlock one exclusive performance workout.",
    locked: true,
  },
  {
    xp: 12500,
    name: "Avatar Frame — Gold",
    desc: "Elemental gold profile frame.",
    locked: true,
  },
  {
    xp: 15000,
    name: "Coach Review",
    desc: "Unlock a 1:1 performance review.",
    locked: true,
  },
  {
    xp: 5000,
    name: "Recovery Guide",
    desc: "Mobility & recovery content pack.",
    locked: false,
  },
];
...
export const programs = [
  {
    ...
    tag: "Build the base.",
    progress: 58,
    sessions: "7 / 12 sessions",
    locked: false,
  },
  {
    id: "power",
    name: "POWER DEVELOPMENT",
    tag: "Complete Foundation II",
    progress: 0,
    sessions: "Locked",
    locked: true,
  },
...
export const trainingFilters = ["Today", "Programs", "Strength", "Core"];
...
export const challenges = [
  {
    cat: "ACTIVE",
    name: "POWER WEEK",
    desc: "Complete 3 power sessions.",
    progress: 66,
    reward: "+400 XP",
  },
  {
    ...
    desc: "Complete 5 mobility sessions.",
    progress: 40,
    reward: "+500 XP",
  },
  {
    cat: "WEEKLY",
    name: "PERFECT WEEK",
    desc: "Train every scheduled day.",
    progress: 60,
    reward: "+600 XP",
  },
  {
    cat: "COMMUNITY",
    name: "CONTROL LADDER",
    desc: "Beat 60s of dead-bug control.",
    progress: 25,
    reward: "+300 XP",
  },
];
...
export const anamnesisSections = [
  {
    id: "personal",
    name: "Personal Data",
    desc: "Age, height, weight, contact",
    done: true,
  },
  { id: "goals", name: "Goals", desc: "What you want to achieve", done: true },
  {
    ...
    desc: "Experience & activity level",
    done: true,
  },
  {
    id: "injuries",
    name: "Injuries & Limitations",
    desc: "Areas to protect",
    done: true,
  },
  {
    id: "health",
    name: "Health History",
    desc: "Conditions & family history",
    done: false,
  },
  {
    id: "meds",
    name: "Medications",
    desc: "What you currently take",
    done: false,
  },
  {
    id: "substances",
    name: "Performance Substances",
    desc: "Anabolics, GLP-1, others",
    done: false,
  },
  {
    id: "consent",
    name: "Consent & Responsibility",
    desc: "Terms & data sharing",
    done: false,
  },
];
...
export const healthProfile = {
  ...
  injuries: [
    {
      area: "Right shoulder",
      note: "Impingement — avoid overhead pressing.",
      active: true,
    },
    {
      area: "Lower back",
      note: "Occasional stiffness after sitting.",
      active: false,
    },
  ],
  conditions: [
  ...
  substanceGroups: [
    {
      ...
      hint: "Testosterone, etc.",
    },
    {
      id: "glp1",
      label: "Weight-management meds",
      hint: "GLP-1 (semaglutide, etc.)",
    },
    {
      id: "stimulant",
      label: "Stimulants / fat burners",
      hint: "Clen, ephedrine, etc.",
    },
